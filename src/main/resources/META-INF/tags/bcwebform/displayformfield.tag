...
<%@attribute name="dfForm" required="true" type="com.bc.web.form.Form"%>
<%@attribute name="formField" required="true" type="com.bc.web.form.FormField"%>
...
<c:if test="${optionsMaxLength == null}">
    <c:set var="optionsMaxLength" value="100"/>
</c:if>
...
<div class="bwf_row">
    <span id="${formField.name}AjaxMessage"></span>  
</div>
